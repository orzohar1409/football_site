...
import { Email, LinkedIn, GitHub, Code, Work, School, Download as DownloadIcon } from '@mui/icons-material';
            ...
            >
                    ...
                    <ListItem>
                        <Grid container alignItems="center" spacing={2}>
                            <Grid item sx={{ width: 60, height: 60 }}>
                                <Work fontSize="large" /> {/* Replaced image with Work icon */}
                            </Grid>
                            <Grid item xs>
                                <ListItemText
                ...
                <List>
                    <ListItem>
                        <Grid container alignItems="center" spacing={2}>
                            <Grid item sx={{ width: 60, height: 60 }}>
                                <School fontSize="large" /> {/* Replaced image with School icon */}
                            </Grid>
                            <Grid item xs>
